...
// MockDeviceClient is an autogenerated mock type for the MockDeviceClient type
type MockDeviceClient struct {
	mock.Mock
}

// Add provides a mock function with given fields: ctx, reqs
func (_m *MockDeviceClient) Add(ctx context.Context, reqs []requests.AddDeviceRequest) ([]common.BaseWithIdResponse, errors.EdgeX) {
...
func (_m *MockDeviceClient) AllDevices(ctx context.Context, labels []string, offset int, limit int) (responses.MultiDevicesResponse, errors.EdgeX) {
...
func (_m *MockDeviceClient) DeleteDeviceByName(ctx context.Context, name string) (common.BaseResponse, errors.EdgeX) {
...
func (_m *MockDeviceClient) DeviceByName(ctx context.Context, name string) (responses.DeviceResponse, errors.EdgeX) {
	ret := _m.Called(ctx, name)
...
func (_m *MockDeviceClient) DeviceNameExists(ctx context.Context, name string) (common.BaseResponse, errors.EdgeX) {
	ret := _m.Called(ctx, name)
...
func (_m *MockDeviceClient) DevicesByProfileName(ctx context.Context, name string, offset int, limit int) (responses.MultiDevicesResponse, errors.EdgeX) {
...
func (_m *MockDeviceClient) DevicesByServiceName(ctx context.Context, name string, offset int, limit int) (responses.MultiDevicesResponse, errors.EdgeX) {
	ret := _m.Called(ctx, name, offset, limit)
...
func (_m *MockDeviceClient) Update(ctx context.Context, reqs []requests.UpdateDeviceRequest) ([]common.BaseResponse, errors.EdgeX) {
	ret := _m.Called(ctx, reqs)
